<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="E_Learning.Admin.Users" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <!-- Header with title and button -->
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="text-dark mb-0">Registered Users</h3>
            <asp:HyperLink ID="lnkViewInactiveUsers" runat="server" NavigateUrl="~/Admin/InactiveUsers.aspx" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-checkbox-wrapper">
                                        <div class='<%# Eval("status").ToString().ToLower() == "active" ? "custom-checkbox checked" : "custom-checkbox" %>'></div>
